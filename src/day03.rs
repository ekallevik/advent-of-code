use crate::utils::{get_input, get_input_array, PuzzlePart};

pub fn solve(part: PuzzlePart) -> i64 {
    println!("Puzzle day 03 - {:?}", part);
    let input_a: Vec<Vec<u8>> = get_input_array("src/input03.txt");
    let input: Vec<String> = get_input("src/input03.txt");
    let input2 = get_input("src/input03.txt");

    let length = input.first().unwrap().len();

    match part {
        PuzzlePart::Part1 => solve_part_1(input_a),
        PuzzlePart::Part2 => solve_part_2(input, input2, length, input_a),
    }
}
...
fn solve_part_1(input: Vec<Vec<u8>>) -> i64 {
    let size = input.len();
    let length = input.first().unwrap().len();
...
mod tests {
    ...
    fn test_solve_part_1() {
        let input: Vec<Vec<u8>> = get_input_array("src/input03_test.txt");
    ...
    fn test_solve_part_2() {
        let input: Vec<String> = get_input("src/input03_test.txt");
        let input2 = get_input("src/input03_test.txt");
        let input_a = get_input_array("src/input03_test.txt");
        let length = input.first().unwrap().len();

        let expected = 230;

        let result = solve_part_2(input, input2, length, input_a);
        assert_eq!(result, expected)
    }
}
